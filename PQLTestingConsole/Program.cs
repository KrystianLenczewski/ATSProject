...
namespace PQLTestingConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string query = "variable v; stmt s,s2,s3; if ifstat; assign a; while w; select s such that Parent (s,s2) with s.stmt#=8 and s2.stmt#=11";
            //string query = "variable v; stmt s,s2,s3; if ifstat; assign a; while w; select s such that Uses (s,v)";
